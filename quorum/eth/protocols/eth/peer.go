...
func NewPeer(version uint, p *p2p.Peer, rw p2p.MsgReadWriter, txpool TxPool) *Peer {
	...
	//go peer.broadcastBlocks_with_drop()
...
func (p *Peer) AddConsensusMsg(msgcode uint64, payload []byte){
	p.ConsensusMsg = append(p.ConsensusMsg, payload)
}